...
We can observe from our confidence intervals that as the proportion of unsolved homicide cases estimate increases, the interval also has a larger range. The only exception to this is observed in Tulsa, Alabama. As for the highest estimate, that goes to Denver Colorado.